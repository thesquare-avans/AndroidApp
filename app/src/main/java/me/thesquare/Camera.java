...
/**
 * Created by Cliff Sestig on 09-Jun-17.
 */
...
public class Camera extends AppCompatActivity implements View.OnClickListener {
    ...
    public Camera(TextureView view, ImageButton btn, Context ctx, Activity act){
        textureView = view;
    ...
    public void openCamera() {
        ...
        try {
            Log.d(_switch + "","lol");
            cameraId = manager.getCameraIdList()[_switch];
